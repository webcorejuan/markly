// App shell: sidebar + topbar, shared by all logged-in screens.

const AppShell = ({ active = 'dashboard', onNav, title, breadcrumb, children, searchPlaceholder = 'Search logs, keys, docs…' }) => {
  const navItems = [
