// Shared icons and UI atoms for Markly.
// Uses Lucide-style 1.5px stroke SVGs.
...
// Pill status dot
const StatusDot = ({ color = 'var(--accent)', size = 6 }) => (
...
// Avatar
const Avatar = ({ name, size = 40, bg = 'var(--accent)' }) => {
...
// Syntax-colored inline code render (extremely light)
const Code = ({ children }) => (
...
Object.assign(window, { Icon, Icons, StatusDot, Wordmark, Avatar, Code });
